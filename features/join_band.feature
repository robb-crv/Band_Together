Feature: User could join a Band
	...
	Background: user "Mario Rossi" is logged in; he creates the band "Band di Rossi"; user "Giulio Bianchi" is watching advertisment for "Band di Rossi"
